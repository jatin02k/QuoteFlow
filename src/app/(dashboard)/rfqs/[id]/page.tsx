...
export const metadata = {
  title: "RFQ Decision Dashboard // RFQPilot",
...
export default async function RFQDetailPage({
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="p-3.5 bg-bg-surface border border-border-default rounded-sm space-y-1">
          ...
          <div className="font-mono font-bold text-xs text-accent">
            {comparisonVendors.filter((v) => Boolean(v.quote)).length} Quotes
          </div>
        </div>
      ...
      {/* MAIN SECTION 1: Quote Comparison Matrix */}
      <section className="space-y-4">
        <QuoteComparison vendors={comparisonVendors} lowestUnitPrice={lowestUnitPrice} />
      </section>
